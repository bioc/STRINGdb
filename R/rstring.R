...
#'     
      ...
      # temp = downloadAbsentFile(paste("https://string.uzh.ch/permanent/string/", version, "/species.tsv", sep=""), oD=tempdir())
    ...
    #}
      ...
      ##        if(is.null(required_score) ) required_score = score_threshold
      ##        string_ids = unique(string_ids)
      ##        urlStr = paste("https://string-db.org/cgi/link_to.pl", sep="" )
      ##
      ##        cat(urlStr)
      ##
      ##        identifiers=""
      ...
      ##'
      ##Descri## ption:
      ##  Retu## rns the enrichment in pathways of the vector of STRING proteins that is given in input.
      ##
      ##Input ## parameters:
      ##  "str## ing_ids"    a vector of STRING identifiers.
      ##  "cat## egory"      category for which to compute the enrichment (i.e. "Process", "Component", "Function", "KEGG", "Pfam", "InterPro", "Tissue", "Disease".  default "Process")
      ##  "met## hodMT"      method to be used for the multiple testing correction. (i.e.  "fdr", "bonferroni"..  default "fdr")
      ##  "iea## "           specify whether to use Elettronic Inferred Annotations (TRUE/FALSE)
      ##  "min## Score"      with Tissue and Disease categories is possible to filter the annotations with an annotation score higher than the threshold (from 0 to 5)
      ##
      ##
      ##Author## (s):
      ##   And## rea Franceschini
      ##'
